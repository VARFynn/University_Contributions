...
% The shock part is now included for the productivity shock.
% As its negative, we had to change the sign of the shock in the respective model equation 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Set shocks
shocks;
var ea;               % Variance of the productivity shock
stderr 1;             % 1 % 
var ep = 0;           % Variance of the energy price shock = 0 -> to exclude
end;
